...
#define SMOOTH_GROUP_WINDOWS S_TURF(31)					///turf/closed/wall/low_wall
...
#define SMOOTH_GROUP_PIZZA_WALLS S_OBJ(17)  ///turf/closed/wall/mineral/pizza, /obj/structure/falsewall/pizza
