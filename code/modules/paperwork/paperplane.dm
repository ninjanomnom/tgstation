...
/obj/item/paperplane/throw_at(atom/target, range, speed, mob/thrower, spin=FALSE, diagonals_first = FALSE, datum/callback/callback, force,  params)
	. = ..(target, range, speed, thrower, FALSE, diagonals_first, callback, force, params)
