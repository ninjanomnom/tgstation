...
/mob/living/simple_animal/parrot
	...
	var/parrot_speed = 0.5 //"Delay in world ticks between movement." according to byond. Yeah, that's BS but it does directly affect movement. Higher number = slower.
